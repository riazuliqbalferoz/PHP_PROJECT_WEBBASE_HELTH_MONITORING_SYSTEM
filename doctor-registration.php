        ...
        <form action="doctor-registration.php" method="post" class="login-form" enctype="multipart/form-data">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user-md"></i>Doctor Register</h3>
           ...
           <div class="form-group">
            ...
            <input type="text" name="name" id="" class="form-control" placeholder=" ENTER YOUR NAME" autocomplete="off">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="bmdc" id="" class="form-control" placeholder="REGISTRATION NO(BMDC)" autocomplete="off">
          </div>
          <div class="form-group">
