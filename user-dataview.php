...
<main class="app-content">
	...
	<div class="row">
		...
		<div class="col-md-5 m-auto">
			<div class="tile">
				<h3 class="tile-title">View Data</h3>
				<div class="tile-body">
...
<hr>
            ...
            <hr>
			  ...
			  &nbsp; &nbsp; <a href="https://siamiot.000webhostapp.com/api/health.php"> View Device temperature </a>
							</div>
						</div>
<hr>
						<div class="form-group row">
...
else  if($BLOOD_S>=$hypertensive_d_stage2 & $BLOOD_S<=$hypertensive_s_consult ){
...
//----------------------------Start of Sugar level Test and Warnig-------------------------------
if ($SUGER<=5 ) {
	echo '<div class="-danger text-success">Your Blood Suger Level is Normal</div>';
}
else if ($SUGER>=8 ) {
	echo '<div class="-danger text-danger">Your Blood Suger Level is High![Please Take your Medicine In Time.]</div>';
}
//----------------------------End of Sugar level Test and Warnig-------------------------------

//---------------------------- Start of Heart Rate Test and Warnig-------------------------------

if ($PULSE<=50) {
	echo '<div class="-danger text-success">Your Pulser Rate si Very Low [Please Take your Medicine]</div>';
}
else if ($PULSE>=50 || $PULSE<=80) {
	echo '<div class="-danger text-success">Your Pulese Rate is Normal!</div>';
}

else if ($SUGER>=90 ) {
	echo '<div class="-danger text-danger">Your Blood Pulse Rate is High![Please Taky your Medicine In Time.]</div>';
}
//---------------------------- End  of Heart Rate Test and Warnig-------------------------------
